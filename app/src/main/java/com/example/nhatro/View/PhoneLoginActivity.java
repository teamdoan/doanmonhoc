...
public class PhoneLoginActivity extends AppCompatActivity {
    ...
    private EditText InputPhoneNuber, InputVerificationCode;
    ...
    protected void onCreate(Bundle savedInstanceState)
    {
        ...
        InputPhoneNuber = (EditText) findViewById(R.id.phone_number_input);
        ...
        SendVerificationCodeButton.setOnClickListener(new View.OnClickListener()
        {
            ...
            public void onClick(View v)
            {
                ...
                String phoneNumber = InputPhoneNuber.getText().toString();
        ...
        VerifyButton.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view)
            {
                ...
                InputPhoneNuber.setVisibility(View.INVISIBLE);
        ...
        callbacks = new PhoneAuthProvider.OnVerificationStateChangedCallbacks()
        {
            ...
            public void onVerificationFailed(FirebaseException e)
            {
                ...
                InputPhoneNuber.setVisibility(View.VISIBLE);
                                    ...
                                    PhoneAuthProvider.ForceResendingToken token)
            {
                ...
                Toast.makeText(PhoneLoginActivity.this,"Code has been sent, please check afnd verify...",Toast.LENGTH_SHORT).show();
    ...
    {
        Intent mainIntent = new Intent(PhoneLoginActivity.this,TrangChuActivity.class);
